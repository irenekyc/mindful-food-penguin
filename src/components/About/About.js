  ...
  return (
    <section className={style.AboutSection} id="about-section">
      <div className={style.half}>
        ...
        <p>
          {" "}
          Mindfulness eating is about using mindfulness to reach a state of full
          attention to your experiences, cravings, and physical cues when eating
        </p>
      </div>
      <div className={style.half}>
        ...
        <p>
          {" "}
          I design and code this mindfulness eating recipes search engine,
          hopeing to help you in the search of freedom.
        </p>
        <p className={style.contacts}>
          ...
          <a
            href="https://irenekyc.github.io/my-site/"
            target="_blank"
            rel="noopener noreferrer"
          >
